...
import { Arrow, Choice, Hassle, StarProfile, Trust } from '../../reusable/Icons'
  ...
  const leaders = [
    {
      ...
      description: 'Deenu Patel is Locum Chief Executive Officer and has been leading the company with a focus on strategic growth and innovation. Under his leadership, Locum has expanded its market presence and developed new service offerings, ensuring the company remains competitive and forward-thinking.'
    },
    {
      id:2,
      imgSrc: dav,
      ...
      description: 'David Newton joined Locum some 15 years ago, bringing with him a wealth of experience in operations and management. His keen insights and strategic initiatives have significantly improved operational efficiency and client satisfaction.'
    },
    {
      id:3,
      imgSrc: jon,
      ...
      description: 'Jon joined Locum as Finance Director in 2019. His financial acumen and dedication have been instrumental in steering the company towards sustainable growth and profitability.'
    },
  ];

  const LeaderBoxSmall = ({ index, isExpanded, toggleExpand , name ,expanded, intro , description , post , imgSrc , name2 }) => {
    return (
  ...
  return(
    <div className='aboutmain'>
        ...
        <div className='aboutleft'>
            ...
            <p>Make the best locum agencies compete to find your perfect locum
jobs. Get offered real shifts, matched exactly to your needs, before
you’ve shared your contact details 🎉</p>
<div className='d-flex'>
<button className='regbtn' onClick={() => window.location.href = '/register'}>Register now</button>
<Arrow />
...
{/* <h1>Our mission & vision</h1> */}
                ...
                <div className='vectorbox-right'>
                    ...
                    <p>
                    To improve patient outcomes by connecting
                    and supporting <span>Healthcare Professionals</span>  and <span>Organisations</span>  
                    – helping ensure we can all access the right care at the right time –
                    worldwide.
                    </p>
                    <button className='aboutreg' onClick={() => window.location.href = '/contactus'}>Contact us</button>
                    </div>
            ...
            <div className='peoplebox'>
                    ...
                    <h1>People are at the
heart of everything
we do</h1>
<p>Our expert teams help seek out and support the Healthcare
Professionals needed to take care of our health every day.</p>
<p>
Everything we do centres on connecting people. </p>
<p>

We connect with Healthcare Professionals worldwide, connecting
them with the Healthcare Organisations that need them, who
connect them with their patients in order to provide excellent
patient care. </p> <p>

And every single connection matters.</p>
