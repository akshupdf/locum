  ...
  return (
    <div className="signup">
      ...
      <div className="signleft signleft2">
        <button onClick={() => window.location.href = '/'} className="back-btn back-btn-2"><svg width="45" height="45" viewBox="0 0 45 45" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="svg-box box-svg-svg" onClick={() => window.location.href = '/'}>
          <img src={logo} alt="logo" className='footer-img mmore-logo-footer' />
        ...
        <form onSubmit={formik.handleSubmit}>
          <div className="input-box">
            <div className="input-text-box">
              <h2>First Name</h2>
              <InputText
                className={`login-input ${formik.touched.firstName && formik.errors.firstName
                  ? "p-invalid"
                  : ""
                  }`}
                name="firstName"
          ...
          <div className="input-box">
            <div className="input-text-box ">
              ...
              <div className='otp-box addon'>
                ...
                <InputText
                  className={`login-input  ${formik.touched.mobileNo && formik.errors.mobileNo
                    ? "p-invalid"
                    : ""
                    }`}
                  name="mobileNo"
